...
def short_term_situation(date, time):
    ...
    params = {'serviceKey' : 'HcYIyLc612fqNjJ/NYs252txzi9CLPoCrXJ7odF8baDERTVYVxSOOPmeKEWFkzL88VMMAOlyv8nUgzu9MUauOA==', 'pageNo' : '1', 'numOfRows' : '4', 'dataType' : 'JSON', 'base_date' : date, 'base_time' : time, 'nx' : '98', 'ny' : '76' }
